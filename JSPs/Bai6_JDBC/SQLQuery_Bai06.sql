...
create table DETAI(
	...
	NAMDANGKY int,
    MOTADETAI nvarchar(259),
    MAGV nvarchar(20) references GIANGVIEN (MAGV) on delete cascade on update cascade
)


insert into GIANGVIEN values(N'GV0001',N'Nguyễn Bùi Thanh Hòa', N'Lĩnh vực về Khoa học cơ bản', '8999123456') 
insert into GIANGVIEN values(N'GV0002',N'Hồ Huỳnh Thủy An', N'Lĩnh vực về Công nghệ thông tin', '8918456894')
insert into GIANGVIEN values(N'GV0003',N'Lê Hoàng Hóa', N'Lĩnh vực về Kỹ thuật phần mềm', '8988345576') 
insert into GIANGVIEN values(N'GV0004',N'Trần Bảo Châu', N'Lĩnh vực về Hệ thống thông tin', '8914324578') 
...
insert into DETAI values(N'DT0005',N'Xây dựng ứng dụng quản lý thư viện',2015, N'Phân tích, thiết kế, xây dựng phần mềm quản lý thư viện cho trường cao đẳng',N'GV0004')
