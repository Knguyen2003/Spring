...
<body>
	...
	<div id="center">
		<div id="formView">
			<form
				action="${pageContext.request.contextPath}/DienThoaiController?action=sua"
				method="post">
				<h2>Cập nhật sản phẩm</h2>
				<label for="maDienThoai">Mã điện thoại:</label> 
				<input type="text" name="maDienThoai" id="maDienThoai" readonly="readonly" value="${dienThoai.maDT}"><br> 
				<label for="tenDienThoai">Tên điện thoại:</label> 
				<input type="text" name="tenDienThoai" id="tenDienThoai" value="${dienThoai.tenDT}" required><br> 
				<label for="namSanXuat">Năm sản xuất:</label> 
				<input type="text" name="namSanXuat" id="namSanXuat" value="${dienThoai.namSX}" required><br> 
				<label for="cauHinh">Cấu hình:</label> 
				<input type="text" name="cauHinh" id="cauHinh" value="${dienThoai.cauHinh}" required><br> 
				<label for="maNhaCungCap">Mã nhà cung cấp:</label> 
				<input type="text" name="maNhaCungCap" id="maNhaCungCap" value="${dienThoai.nhaCungCap.maNCC}" required><br>
